      ...
      <div class="p-8 grid grid-cols-1 md:grid-cols-4 gap-x-20 gap-y-10">
        <div class="md:col-span-1 max-sm:text-center">
          <ul class="flex flex-col">
            ...
            <li @click="switchToStore" class="text-lg font-semibold text-[--text] cursor-pointer hover:text-[--main-special] transition-colors duration-200 ease-in-out border-b border-[--border] py-2">Store</li>
            <li @click="switchToProducts" class="text-lg font-semibold text-[--text] cursor-pointer hover:text-[--main-special] transition-colors duration-200 ease-in-out py-2">Personalization</li>
          </ul>
        </div>
